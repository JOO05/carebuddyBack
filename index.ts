...
app.use(function(req:Request, res:Response, next:NextFunction) {
  res.header("Access-Control-Allow-Origin", "http://kdt-sw-8-team01.elicecoding.com/");
...
mongoose.connect(
  `mongodb+srv://twincornjr:${MONGODB_PASSWORD}@cluster0.3dtsucn.mongodb.net/`,
);
...
//  HTML 파일을 사용할 것이므로 view engine 속성을 "html"로 설정
